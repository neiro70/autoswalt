...
<head>
	...
	<meta name="viewport" content="width=1,initial-scale=1,user-scalable=1" />
	  <title>Seminuevos Volkswagen Centro Automotriz Coyoacan</title>
	  <link rel="shortcut icon" href="img/loboSolo.png" type="image/png">
		...
		<section class="container">
			<section class="login-form">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" role="login">
					<img src="img/loboCentro.png" class="img-responsive" width="90%" />
