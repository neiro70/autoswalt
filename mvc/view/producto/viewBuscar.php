<?php
	...
	$contexto = "http://" . $server ."/AutosProyecto";
	if(!isset($_SESSION['username'])){
		header("location:/AutosProyecto/index.php");
	}
...
<head>
    ...
    <link rel="shortcut icon" href="<?=$contexto?>/img/loboSolo.png" type="image/png">

    <!-- Bootstrap Core CSS -->
    <link href="<?=$contexto?>/css/bootstrap.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
               ...
               <img alt="SemiNuevos" src="<?=$contexto?>/img/daswelt.png" width="24%"  style="padding-top: 10px;padding-left: 10px;">
               <img src="<?=$contexto?>/img/loboSolo.png"  width="5%"  style="padding-top: 10px;" />
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#producto"><i class="fa fa-fw fa-book"></i> Inventario <i class="fa fa-fw fa-caret-down"></i></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i> Inventario
                            </li>
                            <li class="active">
	                           ...
	                           <div class="form-group">
                        			<div class="panel panel-info">
                            			<div class="panel-heading">
			                                <h3 class="panel-title">Lista de Autos</h3>
			                            </div>
  ...
  <div class="modal-dialog">
    ...
    function eliminarProducto(idproducto){
        BootstrapDialog.show({
            ...
            message: 'ï¿½Esta seguro que quiere eliminar el producto?',
            buttons: [{
                label: 'Cancelar',
                cssClass:"btn-danger",
